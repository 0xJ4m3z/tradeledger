...
Environment variables (all optional):
  POLYGON_RPC_URL  — custom RPC endpoint (default: https://polygon-rpc.com)
...
def fetch_wallet_usd_value(address: str) -> float:
    ...
    Raises WalletLookupError on any network or parse failure.
    Never requests private keys or wallet permissions.
    """
    rpc_url = os.getenv("POLYGON_RPC_URL", _DEFAULT_RPC)
